      ...
      <div className={styles.frame}>
        ...
        {activeTab === 'pricing' && (
          <div style={{ display: 'grid', gap: '20px' }}>
            ...
            <SectionCard title="Checkout Settings" description="Manage GST, discounts, GSTIN and the Razorpay-ready payment copy used on the Rozgar checkout page.">
              <div style={{ display: 'grid', gap: '14px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px' }}>
                  ...
                  <Field label="Fallback GSTIN" value={content.pricingPage.checkout.gstin} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, gstin: value } } } : current)} />
            ...
            <SectionCard title="Tax Settings" description="Configure seller GST details, state-based GST rates, HSN and service description used in invoices and billing calculations.">
              <div style={{ display: 'grid', gap: '14px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '14px' }}>
                  <Field label="Seller GSTIN" value={content.pricingPage.checkout.taxSettings.sellerGstin} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, sellerGstin: value } } } } : current)} />
                  <Field label="Seller State" value={content.pricingPage.checkout.taxSettings.sellerState} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, sellerState: value } } } } : current)} />
                  <Field label="Seller State Code" value={content.pricingPage.checkout.taxSettings.sellerStateCode} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, sellerStateCode: value } } } } : current)} />
                  <Field label="Intra-state CGST %" value={content.pricingPage.checkout.taxSettings.intraStateCgstPercent} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, intraStateCgstPercent: value } } } } : current)} />
                  <Field label="Intra-state SGST %" value={content.pricingPage.checkout.taxSettings.intraStateSgstPercent} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, intraStateSgstPercent: value } } } } : current)} />
                  <Field label="Inter-state IGST %" value={content.pricingPage.checkout.taxSettings.interStateIgstPercent} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, interStateIgstPercent: value } } } } : current)} />
                  <Field label="HSN Code" value={content.pricingPage.checkout.taxSettings.hsnCode} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, hsnCode: value } } } } : current)} />
                  <Field label="Seller Legal Name" value={content.pricingPage.checkout.taxSettings.sellerLegalName} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, sellerLegalName: value } } } } : current)} />
                  <Field label="Seller Email" value={content.pricingPage.checkout.taxSettings.sellerEmail} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, sellerEmail: value } } } } : current)} />
                  <Field label="Seller Phone" value={content.pricingPage.checkout.taxSettings.sellerPhone} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, sellerPhone: value } } } } : current)} />
                </div>
                <label style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', color: '#0f172a', fontSize: '13px', fontWeight: 600 }}>
                  <input
                    type="checkbox"
                    checked={content.pricingPage.checkout.taxSettings.gstEnabled}
                    onChange={event => setContent(current => current ? {
                      ...current,
                      pricingPage: {
                        ...current.pricingPage,
                        checkout: {
                          ...current.pricingPage.checkout,
                          taxSettings: {
                            ...current.pricingPage.checkout.taxSettings,
                ...
                <TextAreaField label="Service Description" value={content.pricingPage.checkout.taxSettings.serviceDescription} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, serviceDescription: value } } } } : current)} rows={2} />
                <TextAreaField label="Seller Address" value={content.pricingPage.checkout.taxSettings.sellerAddress} onChange={value => setContent(current => current ? { ...current, pricingPage: { ...current.pricingPage, checkout: { ...current.pricingPage.checkout, taxSettings: { ...current.pricingPage.checkout.taxSettings, sellerAddress: value } } } } : current)} rows={3} />
              </div>
            </SectionCard>
