        ...
        <main className="workspace-shell">
          <header className="topbar">
            ...
            <div className="page-actions">
              <button className="secondary-btn" onClick={() => window.open('https://www.scalevyapar.in/dashboard', '_blank', 'noopener,noreferrer')}>
                <ArrowUpRight className="button-icon" />
                Client Dashboard
              </button>
              <button className="secondary-btn" onClick={() => window.open('https://www.scalevyapar.in/', '_blank', 'noopener,noreferrer')}>
                <ArrowUpRight className="button-icon" />
                ScaleVyapar Website
              </button>
              <button className="secondary-btn" onClick={() => window.open('/admin/website', '_blank', 'noopener,noreferrer')}>
                <ArrowUpRight className="button-icon" />
            ...
            <div className="workspace-stack">
              ...
              <div className="surface-card utility-bar">
                ...
                <div className="utility-actions">
                  ...
                  <button className="secondary-btn" onClick={() => window.open('https://rozgar.scalevyapar.in/', '_blank', 'noopener,noreferrer')}>
                    <ArrowUpRight className="button-icon" />
                    Rozgar Website
                  </button>
