...
const WEBSITE_ASSET_BUCKET = 'labour-company-website-assets'
...
export async function POST(request: NextRequest) {
  try {
    ...
    const assetKey = String(formData.get('assetKey') || 'hero').trim() || 'hero'
    ...
    const safeAssetKey = sanitizeFileName(assetKey) || 'hero'
