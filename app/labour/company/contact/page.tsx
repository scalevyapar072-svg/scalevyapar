...
export default async function LabourCompanyContactPage() {
  ...
  return (
    <CompanySiteShell content={content} currentPath="/labour/company/contact" initialHostname={hostname}>
      <div className={styles.contactPage}>
        <nav className={styles.contactBreadcrumb} aria-label="Breadcrumb">
          <Link href={resolveHref('/labour/company')}>Home</Link>
        ...
        <section className={styles.contactMapSection}>
          <div className={styles.contactMapFrame}>
            ...
            <div className={styles.contactMapOverlayCard}>
              ...
              <Link href={resolveHref(contact.directionsHref)} className={styles.contactMapButton}>
                <ArrowRight size={16} />
        ...
        <section className={styles.contactCtaSection}>
          <div className={styles.contactCtaPanel}>
            ...
            <div className={styles.contactCtaButtons}>
              <Link href={resolveHref(contact.finalCta.primaryCtaHref)} className={styles.contactCtaPrimaryButton}>
                {contact.finalCta.primaryCtaLabel}
              </Link>
              <Link href={resolveHref(contact.finalCta.secondaryCtaHref)} className={styles.contactCtaSecondaryButton}>
