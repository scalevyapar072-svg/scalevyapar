...
export function PricingPageClient({
  ...
  content: LabourCompanyWebsiteContent['pricingPage']
    ...
    <div className={styles.pricingPage}>
        ...
        {content.plans.map((plan, index) => {
          ...
          return (
            ...
            >
              ...
              <Link href={resolveHref(checkoutHref)} className={styles.pricingPlanButton}>
                {plan.buttonLabel}
              </Link>
      ...
      <section className={styles.pricingFinalCta}>
        ...
        <div className={styles.pricingFinalCtaButtons}>
          <Link href={resolveHref(content.finalCta.primaryCtaHref)} className={styles.homeHeaderSecondaryButton}>
            {content.finalCta.primaryCtaLabel}
          </Link>
          <Link href={resolveHref(content.finalCta.secondaryCtaHref)} className={styles.homeHeaderGhostButton}>
