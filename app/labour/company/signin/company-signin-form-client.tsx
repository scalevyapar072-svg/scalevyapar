    ...
    try {
      const response = await fetch('/api/auth/forgot-password', {
        ...
        body: JSON.stringify({
          ...
          redirectPath: isRozgarSubdomainHost(hostname) ? '/reset-password' : '/labour/company/reset-password'
        })
      })
  ...
  return (
    <form className={styles.signinFormCard} onSubmit={handleSubmit}>
      ...
      <div className={styles.signinRegisterPrompt}>
        ...
        <Link href={resolveHref('/labour/company/company-registration')} className={styles.signinSecondaryButton}>
