    ...
    <CompanySiteShell content={content} currentPath="/labour/company/signin">
      ...
      <section className={styles.splitGrid}>
        <div className={styles.formBox}>
          <CompanyPanelClient signinMode content={content.companyPanel} />
        </div>
        ...
        <div className={styles.card}>
          ...
          <div className={styles.stack}>
            <a href="/labour/company/company-registration" className={styles.secondaryButton}>Open company enquiry</a>
