...
export default function FloatingWhatsApp({ content }: { content: MainWebsiteContent }) {
  if (!content.contact.whatsappLink.trim()) {
    return null
  }
  ...
  return (
    <>
      <style>{`
        .wa-wrap { position: fixed; bottom: 32px; right: 32px; z-index: 999; }
        .wa-btn { width: 60px; height: 60px; background: #25d366; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 20px rgba(37,211,102,0.4); text-decoration: none; position: relative; transition: transform 0.3s; }
      ...
      <div className="wa-wrap">
        <a href={content.contact.whatsappLink} className="wa-btn" target="_blank" rel="noreferrer">
