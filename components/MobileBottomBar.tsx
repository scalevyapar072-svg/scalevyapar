...
function isRozgarHost(hostname: string) {
  return hostname === 'rozgar.scalevyapar.in' || hostname.startsWith('rozgar.')
}

function isRozgarPublicPath(pathname: string) {
...
export default function MobileBottomBar({ chatHref = null }: MobileBottomBarProps) {
  ...
  const hideOnRozgarPages =
    ...
    normalizedPathname === '/labour/company' ||
    normalizedPathname.startsWith('/labour/company/') ||
    (isRozgarHost(hostname) && isRozgarPublicPath(normalizedPathname))
      ...
      <div className="mobile-bottom-bar">
        <div className="mobile-bottom-grid">
          ...
          {resolvedChatHref ? (
            ...
            <div className="mobile-bottom-placeholder" aria-hidden="true" />
          )}
