...
const defaultContent: LabourCompanyWebsiteContent = {
  ...
  home: {
    ...
    categories: {
      ...
      title: 'Find Workers by Category',
  ...
  aboutPage: {
    hero: {
      ...
      bulletPoints: [
        ...
        'Only Active and Relevant Profiles'
      ],
  ...
  searchPage: {
    ...
    trustPoints: [
      ...
      'Only Relevant Results, No Unnecessary Data'
    ],
    imageSrc: '/worker-hero-reference.png',
    floatingCardTitle: 'Find the Best Workers for Your Business',
    floatingCardDescription: 'Verified profiles • Active and relevant • Faster hiring',
  ...
  companyPanel: {
    ...
    hero: {
      ...
      trustCardSubtitle: 'Verified profiles • Active and relevant • Faster hiring',
...
const normalizeContent = (raw: unknown): LabourCompanyWebsiteContent => {
  ...
  const mergedPricingTaxSettings =
    typeof mergedPricingCheckout.taxSettings === 'object' && mergedPricingCheckout.taxSettings
      ? mergedPricingCheckout.taxSettings as Record<string, unknown>
      : {}
    ...
    pricingPage: {
      ...
      checkout: {
        ...
        taxSettings: {
          ...
          sellerGstin:
            (typeof mergedPricingTaxSettings.sellerGstin === 'string' && mergedPricingTaxSettings.sellerGstin.trim()
              ? mergedPricingTaxSettings.sellerGstin.trim()
              : typeof mergedPricingCheckout.sellerGstin === 'string' && mergedPricingCheckout.sellerGstin.trim()
                ? mergedPricingCheckout.sellerGstin.trim()
                : typeof mergedPricingCheckout.gstin === 'string' && mergedPricingCheckout.gstin.trim()
                  ? mergedPricingCheckout.gstin.trim()
                  : defaultContent.pricingPage.checkout.taxSettings.sellerGstin),
          sellerState:
            (typeof mergedPricingTaxSettings.sellerState === 'string' && mergedPricingTaxSettings.sellerState.trim()
              ? mergedPricingTaxSettings.sellerState.trim()
              : defaultContent.pricingPage.checkout.taxSettings.sellerState),
          sellerStateCode:
            (typeof mergedPricingTaxSettings.sellerStateCode === 'string' && mergedPricingTaxSettings.sellerStateCode.trim()
              ? mergedPricingTaxSettings.sellerStateCode.trim()
              : defaultContent.pricingPage.checkout.taxSettings.sellerStateCode),
          gstEnabled: typeof mergedPricingTaxSettings.gstEnabled === 'boolean'
            ? mergedPricingTaxSettings.gstEnabled
            : defaultContent.pricingPage.checkout.taxSettings.gstEnabled,
          intraStateCgstPercent:
            (typeof mergedPricingTaxSettings.intraStateCgstPercent === 'string' && mergedPricingTaxSettings.intraStateCgstPercent.trim()
              ? mergedPricingTaxSettings.intraStateCgstPercent.trim()
              : defaultContent.pricingPage.checkout.taxSettings.intraStateCgstPercent),
          intraStateSgstPercent:
            (typeof mergedPricingTaxSettings.intraStateSgstPercent === 'string' && mergedPricingTaxSettings.intraStateSgstPercent.trim()
              ? mergedPricingTaxSettings.intraStateSgstPercent.trim()
              : defaultContent.pricingPage.checkout.taxSettings.intraStateSgstPercent),
          interStateIgstPercent:
            (typeof mergedPricingTaxSettings.interStateIgstPercent === 'string' && mergedPricingTaxSettings.interStateIgstPercent.trim()
              ? mergedPricingTaxSettings.interStateIgstPercent.trim()
              : defaultContent.pricingPage.checkout.taxSettings.interStateIgstPercent),
          hsnCode:
            (typeof mergedPricingTaxSettings.hsnCode === 'string' && mergedPricingTaxSettings.hsnCode.trim()
              ? mergedPricingTaxSettings.hsnCode.trim()
              : defaultContent.pricingPage.checkout.taxSettings.hsnCode),
          serviceDescription:
            (typeof mergedPricingTaxSettings.serviceDescription === 'string' && mergedPricingTaxSettings.serviceDescription.trim()
              ? mergedPricingTaxSettings.serviceDescription.trim()
              : defaultContent.pricingPage.checkout.taxSettings.serviceDescription),
          sellerLegalName:
          ...
          sellerAddress:
            (typeof mergedPricingTaxSettings.sellerAddress === 'string' && mergedPricingTaxSettings.sellerAddress.trim()
              ...
              : defaultContent.pricingPage.checkout.taxSettings.sellerAddress),
          sellerEmail:
            (typeof mergedPricingTaxSettings.sellerEmail === 'string' && mergedPricingTaxSettings.sellerEmail.trim()
              ? mergedPricingTaxSettings.sellerEmail.trim()
              : defaultContent.pricingPage.checkout.taxSettings.sellerEmail),
          sellerPhone:
