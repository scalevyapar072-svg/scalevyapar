...
const mapJobPostRow = (row: Record<string, unknown>): LabourJobPostRecord => ({
  ...
  reviewStatus: (toString(row.review_status) || null) as LabourJobPostRecord['reviewStatus'],
  reviewReason: toString(row.review_reason),
  submittedAt: toString(row.submitted_at),
  reviewedAt: toString(row.reviewed_at),
