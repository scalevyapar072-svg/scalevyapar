...
class WorkerLocalizations {
  ...
  String get dailyDeductionAmountLabel =>
      isHindi ? 'दैनिक कटौती राशि' : 'Daily Deduction Amount';
  String get nextDailyDeduction =>
      isHindi ? 'अगली दैनिक कटौती' : 'Next daily deduction';
  String get activateWorkerAccess =>
      isHindi ? 'सक्रिय करें' : 'Activate';
  String get deactivateWorkerAccess =>
      isHindi ? 'निष्क्रिय करें' : 'Deactivate';
  String get activateWorkerAccessSuccess =>
      isHindi ? 'वर्कर एक्सेस फिर से सक्रिय हो गया।' : 'Worker access is active again.';
  String get deactivateWorkerAccessSuccess =>
      isHindi ? 'वर्कर एक्सेस निष्क्रिय कर दिया गया है।' : 'Worker access has been deactivated.';
  String get deactivateWorkerAccessTitle =>
      isHindi ? 'वर्कर एक्सेस निष्क्रिय करें?' : 'Deactivate worker access?';
  String get deactivateWorkerAccessMessage => isHindi
      ? 'दैनिक कटौती अगले 24 घंटे के चक्र से रुक जाएगी। आपकी वॉलेट राशि सुरक्षित रहेगी।'
      : 'Daily deduction will stop from the next 24-hour cycle. Your wallet balance will remain safe.';
  String get workerPlanPaused =>
      isHindi ? 'वर्कर एक्सेस रोका गया है' : 'Worker access is paused';
  String get workerPlanPausedSubtitle => isHindi
      ? 'आपके सक्रिय करने तक दैनिक कटौती रुकी रहेगी।'
  ...
  String prettyValue(String value) {
    ...
    const hindi = {
      'active': 'सक्रिय',
      'pending': 'लंबित',
      'inactive_paused_by_worker': 'वर्कर ने रोका',
